            ...
            data.meals.forEach((element) => {
                ...
                <div id="card" class="card mb-3" style="width: 20rem;">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between mt-5">
                            <button type="button" class="btn btn-outline-light" onclick="showMealDetails(${element.idMeal})">More Details</button>
                            <button id="main${element.idMeal}" class="btn btn-outline-light" onclick="addRemoveToFavList(${element.idMeal})" style="border-radius:50%"><i class="fa-solid fa-heart fa-beat"></i></button>
                        </div>
                    </div>
                </div>
                `;
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-md-12 text-center">
                            <span class="display-1 d-block"><i class="fa-solid fa-beer-mug-empty"></i></span>
                            <div class="mb-4 lead">
    ...
    await fetchMealsFromApi(url,id).then(data=>{
        ...
        for (let i = 1; i <= 20; i++) {
            if (val[`strIngredient${i}`]) {
                ingredients.push(`${val[`strIngredient${i}`]} - ${val[`strMeasure${i}`]}`);
            }else {
                break;
            }     
        }
        ...
        html += `
          <div id="meal-details" class="mb-5">
            ...
            <div id="meal-instruction" class="mt-3 row">
                <div class="col -6">
        ...
        html += `
            <div class="page-wrap d-flex flex-row align-items-center">
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-md-12 text-center">
                        <i class="fa-solid fa-wine-glass-empty fa-10x fa-shake"></i>
                            <div class="mb-4 lead">
                ...
                <div id="card" class="card mb-3" style="width: 20rem;">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between mt-5">
                            ...
                            <button id="main${data.meals[0].idMeal}" class="btn btn-outline-light active" onclick="addRemoveToFavList(${data.meals[0].idMeal})" style="border-radius:50%"><i class="fa-solid fa-heart fa-beat"></i></button>
                        </div>
                    </div>
                </div>
                `;
